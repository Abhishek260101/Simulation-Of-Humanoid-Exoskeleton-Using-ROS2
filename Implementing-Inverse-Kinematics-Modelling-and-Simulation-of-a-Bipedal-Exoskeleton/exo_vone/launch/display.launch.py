...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    urdf_file = 'exo_vone.urdf'
    xacro_file = "exo_vone.urdf.xacro"
    #xacro_file = "box_bot.xacro"
    package_description = "exo_vone"
    use_urdf = False
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("exo_vone"), "rviz", "display_default.rviz"]
    )
